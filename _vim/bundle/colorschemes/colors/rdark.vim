...
hi Question guifg=#fcaf3e ctermfg=215 " guifg=#8ae234 ctermfg=113 ctermfg=113 gui=none
hi WildMenu guifg=#eeeeec ctermfg=7 ctermfg=7 guibg=#0e1416 ctermbg=233
hi LineNr guifg=#3f4b4d ctermfg=238 guibg=#000000 ctermbg=0 ctermbg=0
hi SignColumn guibg=#1e2426 ctermbg=235

" Pmenu
hi Pmenu guibg=#2e3436 ctermbg=236 guifg=#eeeeec ctermfg=7 ctermfg=7
...
hi FoldColumn guifg=#3465a4 ctermfg=61 guibg=#000000 ctermbg=0 ctermbg=0
...
hi TabLineSel guibg=#555753 ctermbg=240 guifg=#eeeeec ctermfg=7 ctermfg=7 gui=none
...
" Syntax
hi Comment guifg=#656763 ctermfg=241 gui=none
